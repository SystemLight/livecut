class LiveCut {
  public handleBox: HTMLDivElement
  public handle: HTMLDivElement
  public mask: HTMLDivElement
  public diffInstance: HTMLImageElement | HTMLCanvasElement | HTMLIFrameElement | null // 对比实例对象
  public isPersist: boolean  // 是否持久展开
  public startX: number // 鼠标按下的开始坐标
  public handleWidth: number // 控制把手宽度
  public currentFoldSize: number // 当前展开的宽度
  public width: number // 设计图宽度
  public height: number // 设计图高度
  public type: 'img' | 'iframe' | 'reprint' | null // 渲染类型
  private _isBindWindowScroll: boolean // 是否绑定了window滚动事件
  public static geometryConfig = '目标浏览器控制台输入：{w:document.body.scrollWidth,h:document.body.scrollHeight}'
  ...
  static reprint(urlPath, height: number) {
